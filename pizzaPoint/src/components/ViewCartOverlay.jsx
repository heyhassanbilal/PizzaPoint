...
return (
    <>
        <div className='fixed bottom-0 p-5 left-1/2 transform -translate-x-1/2 flex justify-around items-center bg-brandRed w-[25rem] h-16 rounded-t-lg hover:cursor-pointer z-40' onClick={()=> setIsCartOpen(true)}>
